...
<main class="wrap how">
  ...
  to it, or let the page pick a line of five stations across the path — the spread that measures the asteroid's shape. The
  rest of the track around the world is drawn too, bright only over the stretch where the star is up in a dark sky, and the
  shadow will play across it if you ask. As on the other pages, a compact description of each event lets your browser work out how close the
  ...
  <ul>
    ...
    <li><b>Seeing a star.</b> Visibility is a rule of thumb. Haze, light pollution, your instrument and your eyes decide. The
    aperture presets on the asteroid pages are the same kind of guess: each limit sits about a magnitude short of what that
    aperture can just detect, because a star at the very limit is lost in the noise long before the asteroid covers it, and a
    camera on the same telescope reaches two or three magnitudes deeper.</li>
