...
<main class="wrap how">
  ...
  month page hands all of that to a single page, which draws the one you asked for and puts its path on a street map. As on the other pages, a compact description of each event lets your browser work out how close the
